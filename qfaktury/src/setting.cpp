...
void Setting::apply() {
  ...
  QMessageBox::information(
      this, QString("Zapisywanie zmian"),
      QString("Zmiany zostaną wprowadzone po zrestartowaniu programu"),
      QMessageBox::Ok);
}
...
void Setting::defTextBtnClick() {
  ...
  qDebug() << "[" << __FILE__ << ": " << __LINE__ << "] " << __FUNCTION__;
  additText->setText(QString("towar odebrałem zgodnie z fakturą"));
}
...
void Setting::setDefaultClick() {
  ...
  if (QMessageBox::question(
          this, "QFaktury GPL",
          QString("Czy napewno chcesz przywrócić ustawienia domyślne?"),
...
void Setting::addLogoBtnClick() {
  ...
  QString ofn = QFileDialog::getOpenFileName(
      this, QString("Wybierz plik do wstawienia jako logo"), "",
      QString("Obrazki (*.jpg *.png)"));
...
void Setting::addStempBtnClick() {
  ...
  QString ofn = QFileDialog::getOpenFileName(
      this, QString("Wybierz plik do wstawienia jako pieczątka"), "",
      QString("Obrazki (*.jpg *.png)"));
...
void Setting::addSignBtnClick() {
  ...
  QString ofn = QFileDialog::getOpenFileName(
      this, QString("Wybierz plik do wstawienia jako podpis"), "",
      QString("Obrazki (*.jpg *.png)"));
...
void Setting::helpFuncAddNr(QLineEdit *lineEd, QListWidget *listWg,
  ...
  if (lineEd->text() != "") {
    ...
    QMessageBox::information(this, QString("Uwaga!!"), text, QMessageBox::Ok);
    return;
  }
...
void Setting::currAddBtnClick() {
  ...
  helpFuncAddNr(currEdit, currlBox,
                QString("Nie można dodać. Pole jest puste."));
}
...
void Setting::currDelBtnClick() {
  ...
  helpFuncDelNr(currlBox, QString("Musisz coś zaznaczyć, żeby usuwać."));
}
...
void Setting::corDelBtnClick() {
  ...
  helpFuncDelNr(correctsBox, QString("Musisz coś zaznaczyć, żeby usuwać."));
}
...
void Setting::vatAddBtnClick() {
  ...
  helpFuncAddNr(vatEdit, vatlBox, QString("Nie można dodać. Pole jest puste."));
}
...
void Setting::vatDelBtnClick() {
  ...
  helpFuncDelNr(vatlBox, QString("Musisz coś zaznaczyć, żeby usuwać."));
}
...
void Setting::currencyDelBtnClick() {
  ...
  helpFuncDelNr(currencylBox, QString("Musisz coś zaznaczyś, żeby usuwać."));
}
...
void Setting::paymDelBtnClick() {
  ...
  helpFuncDelNr(paymlBox, QString("Musisz coś zaznaczyć, żeby usuwać."));
}
...
void Setting::helpFuncAp(QListWidget *listWg) {
  ...
  if (selNr == 0) {
    QMessageBox::information(
        this, QString("Uwaga!!"),
        QString("Element znajduje się już na pierwszym miejscu na liście."),
        QMessageBox::Ok);
    return;
  }
  ...
  if (selNr > 0) {
    ...
    QMessageBox::information(this, QString("Uwaga!!"),
                             QString("Musisz coś zaznaczyć, żeby przesuwać."),
                             QMessageBox::Ok);
    return;
  }
...
void Setting::helpFuncDown(QListWidget *listWg) {
  ...
  if (selNr == recCount - 1) {
    ...
    QMessageBox::information(
        this, QString("Uwaga!!"),
        QString("Element znajduje się już na ostatnim miejscu na liście."),
        QMessageBox::Ok);
    return;
  }
