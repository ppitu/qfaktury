...
Send::Send(QVector<BuyerData> buyersList, QVector<InvoiceData> invList,
  ...
  setWindowTitle(QString("Generowanie wiadomości"));
}
...
IntroPage::IntroPage(QWidget *parent) : QWizardPage(parent) {
  ...
  setTitle(QString("Wprowadzenie"));

  label =
      new QLabel(QString("Generator pomoże w kolejnych krokach wysłać"
...
ClassInvoicePage::ClassInvoicePage(QVector<BuyerData> buyList,
  ...
  invoices->setText(QString("Wybierz fakturę"));
  ...
  invoicesList->setHorizontalHeaderLabels(
      QStringList() << QString("Symbol") << QString("Data") << QString("Typ")
                    << QString("Nabywca") << QString("NIP"));
...
EmailPage::EmailPage(QWidget *parent) : QWizardPage(parent) {
  ...
  lab1->setText(QString("Host: "));

  QLabel *lab2 = new QLabel;
  lab2->setText(QString("Port: "));
  ...
  groupBox = new QGroupBox(QString("&Lista skrzynek pocztowych"));
  QVBoxLayout *groupBoxLayout = new QVBoxLayout;

  QRadioButton *radioButton1 = new QRadioButton(QString("&Gmail"));
  radioButton1->setCheckable(true);
  QRadioButton *radioButton2 = new QRadioButton(QString("o&2"));
  radioButton2->setCheckable(true);
  QRadioButton *radioButton3 = new QRadioButton(QString("&Interia"));
  radioButton3->setCheckable(true);
  QRadioButton *radioButton4 = new QRadioButton(QString("O&net"));
  radioButton4->setCheckable(true);
  QRadioButton *radioButton5 = new QRadioButton(QString("&WP"));
  radioButton5->setCheckable(true);
  QRadioButton *radioButton6 = new QRadioButton(QString("Y&ahoo"));
  radioButton6->setCheckable(true);
  QRadioButton *radioButton7 =
      new QRadioButton(QString("&HotMail (stare serwery)"));
  radioButton7->setCheckable(true);
  QRadioButton *radioButton8 = new QRadioButton(QString("G&azeta"));
  radioButton8->setCheckable(true);
  QRadioButton *radioButton9 = new QRadioButton(QString("&Aol"));
  radioButton9->setCheckable(true);
  QRadioButton *radioButton10 = new QRadioButton(QString("F&oxmail / QQMail"));
  radioButton10->setCheckable(true);
  QRadioButton *radioButton11 = new QRadioButton(QString("&Outlook"));
  ...
  QGroupBox *groupBox2 = new QGroupBox(QString("&Lista protokołów"));
  QVBoxLayout *groupBoxLayout2 = new QVBoxLayout;

  QRadioButton *radioButton1_1 = new QRadioButton(QString("&SSL"));
  radioButton1_1->setCheckable(true);
  QRadioButton *radioButton2_2 = new QRadioButton(QString("T&CP"));
  radioButton2_2->setCheckable(true);
  QRadioButton *radioButton3_3 = new QRadioButton(QString("&TLS"));
