...
void InvoiceRR::invoiceRRInit() {
  ...
  additEdit->setText(QString("Oświadczam, że jestem rolnikiem ryczałtowym "
  ...
  ifpaysVAT->setText(QString("Jest płatnikiem VAT"));
...
void InvoiceRR::makeInvoice(bool to_print) {
  ...
  if (!ifpaysVAT->isChecked()) {
    QMessageBox::information(this, "QFaktury",
                             QString("Zaznacz opcję \"jest płatnikiem VAT\" dla "
